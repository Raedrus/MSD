...
y_homingswitch = Button(9, pull_up = True)
x_homingswitch = Button(11, pull_up = True)
    ...
    if homing == False and tobin == None:
        ...
        if selected_xy == "X":
            ...
            while x_homingswitch.is_pressed == False:
                ...
                x_drv8825_step.blink(background = True,  n= abs(2), on_time =time_delay, off_time = time_delay)
            ...
            while y_homingswitch.is_pressed == False:
                y_drv8825_step.blink(background = True,  n= abs(2), on_time =time_delay, off_time = time_delay + 0.0003)
...
#drivedrv8825(ysteps_toDesti, dirY, "Full", "Y", 0.0004, tobin = 1) #Move the Y-axis towards one encoder
...
#drivedrv8825(0, dirY, "Full", "XY", 0.001, list_DirXY = [0, 1], list_XYSteps = [300, 6000], invert_xDir = True, invert_yDir = True) #Direction inversion

#y_drv8825_step.blink(background = False,  n= 1800, on_time =0.001, off_time = 0.0004)
