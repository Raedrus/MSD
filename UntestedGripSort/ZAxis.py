...
z_up_lim_pin = 6
z_lowlim_pin = 5  # A chosen pin 26 that seems unoccupied on whatsapp schematic (15 Aug, SCH_Raspberry Pi_1-Version 2_2024-08-15

# XY Gantry Motors Drivers
pin_z_drv8825_en = 25
pin_z_drv8825_step = 8
pin_z_drv8825_dir = 7  # 1 for clockwise, 0 for counter-clockwise
...
ZUP_lim = Button(z_up_lim_pin, pull_up=False)
ZLOW_lim = Button(z_lowlim_pin, pull_up=False)
...
def full_ele_gripper():
    ...
    while ZUP_lim.is_pressed != False:
...
def full_lower_gripper():
    ...
    while ZLOW_lim.is_pressed != False:
        z_drv8825_step.blink(background=False, n=20, on_time=0.001, off_time=0.0004)
