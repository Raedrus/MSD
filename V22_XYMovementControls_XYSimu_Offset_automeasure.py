...
def getshortestdist(gripper_posi, typeposi_data, distperpix):
    ...
    print("current_shortest= ", current_shortest) #For Verification
    print("X_short_dif_posi= ", x_short_dif_posi) #For Verification
    print("Y_short_dif_posi= ", y_short_dif_posi) #For Verification
...
def drivedrv8825(steps, dir, microstep, selected_xy, time_delay, homing = False, tobin = None, list_XYSteps = None, list_DirXY = None, invert_xDir = False, invert_yDir = False):
...
#drivedrv8825(2000, dirY, "Full", "Y", 0.0004) #(Number of steps, direction, physical microstep settings (wired), which motor, time delay between steps)
...
#drivedrv8825(0, dirY, "Full", "XY", 0.0004, list_DirXY = dirXY, list_XYSteps = [20, 20], invert_yDir = True) #Direction inversion
