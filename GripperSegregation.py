...
def GripperToWaste():
    ...
    xy_steps_toDesti, waste_sz = gan.getshortestdist([0, 0], type_posi,
                                                     30 / 270)  # Last parameter is distance per pixel value
    ...
    gan.drivedrv8825(0, dirXY, "Full", "XY", 0.001, list_DirXY=dirXY, list_XYSteps=xy_steps_toDesti, invert_xDir=False,
                     invert_yDir=True)
