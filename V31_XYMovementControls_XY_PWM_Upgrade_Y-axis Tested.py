...
y_drv8825_step = PWMOutputDevice(pin_y_drv8825_step, frequency = 10000)
    ...
    if homing == False and tobin == None:
        ...
        if selected_xy == "X":
            ...
            while y_homingswitch.is_pressed == False:
                y_drv8825_step.blink(background = True,  n= abs(2), on_time =time_delay, off_time = time_delay)
        ...
        while ir_enc1.value == False:
                y_drv8825_step.blink(background = False,  n= 20, on_time =time_delay, off_time = time_delay)
...
#drivedrv8825(0, dirY, "Full", "XY", 0.001, list_DirXY = dirXY, list_XYSteps = [300, 800], invert_xDir = True, invert_yDir = True) #Direction inversion

#y_drv8825_step.blink(background = False,  n= 6000, on_time =0.001, off_time = 0.001)
